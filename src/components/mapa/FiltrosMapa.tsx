...
export function FiltrosMapa() {
  ...
  return (
    <div className="absolute top-14 left-3 z-[10000] bg-white/95 dark:bg-gray-900/95 backdrop-blur-md rounded-2xl shadow-xl p-3.5 min-w-[170px] border border-gray-100 dark:border-gray-800" style={{ touchAction: 'manipulation' }}>
